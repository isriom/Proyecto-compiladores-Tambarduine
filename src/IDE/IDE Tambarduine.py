...
class Window:
    def __init__(self, master): 
        ...
        self.wordlist = [ ["class", "Def", "for", "If", "Else", "elif", "import", "from", "as", "break", "while", "Set","Exec" ],
    ...
    def display(self):
    	...
    	self.printwindow.insert("3.0",self.T1.get("1.0", "end"))
    	self.printwindow.insert("4.0","\n")
